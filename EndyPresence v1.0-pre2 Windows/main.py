...
try:
  ...
  ctypes.windll.user32.MessageBoxW(0, "Dependencies installed. Reopen the program to continue!", "EndyPresence", 0)
  exit(0)
...
with open(os.path.join(current_dir, "Database.json"), "r+") as db:
  ...
  if firstrun["FR"] == 1:
    ctypes.windll.user32.MessageBoxW(0, "Check your browser to authorize!", "EndyPresence", 0)
...
try:
  ...
  ctypes.windll.user32.MessageBoxW(0, "Can't connect to Discord RPC. Check if Discord is currently running.", "EndyPresence - Connection Error", 0)
